...
class TaskSecondaryItem extends StatefulWidget {
  TabDeviceRecordModel _tabDeviceRecordModel;

  TaskSecondaryItem(this._tabDeviceRecordModel);

  @override
  createState() {
    return new TaskSecondaryItemState(_tabDeviceRecordModel);
  }
}

class TaskSecondaryItemState extends State<TaskSecondaryItem> {
  TabDeviceRecordModel _tabDeviceRecordModel;

  TaskSecondaryItemState(this._tabDeviceRecordModel);
        ...
        onTap: () {
          ...
          if (_tabDeviceRecordModel.recordType == 0) {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) =>
                    DeviceAbnormalPage(_tabDeviceRecordModel, _title)));
